<script>
    ...
    const form = useForm({
        title: '', author_id: '', synopsis: '', publisher: '',
        publication_year: '', language: 'English', page_number: '',
        availability: 1, genres: [], images: [], image_descriptions: [],
    });

    const submit = () => $form.post('/admin/books', { forceFormData: true });
